...
var strokeColorFolder = gui.addFolder('stroke color');
...
var backgroundColorFolder = gui.addFolder('background color');
...
backgroundColorFolder.add(backgroundColor, 'a', 0, 0.02); // Animation Loop
...
function animate() {
  ...
  c.strokeStyle = "hsl(".concat(Math.abs(Math.sin(increment) * strokeColor.h), ", ").concat(strokeColor.s, "%, ").concat(strokeColor.l, "%)");
  c.stroke();
